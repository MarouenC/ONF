...
<div class="container">
    ...
    {{ Form::open(array('url' => '/product', 'method' => 'post', 'files' => true)) }}
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input id="product_price" type="integer" class="form-control @error('product_price') is-invalid @enderror" name="product_price" value="{{ old('product_price') }}" required autocomplete="product_price" autofocus>
                @error('product_price')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                class="form-control @error('product_description') is-invalid @enderror" 
                 ...
                 required autocomplete="product_description" autofocus>
                </textarea>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <div class="input-group rounded mb-3">
                    ...
                    <input type="integer" name="product_phone" class="form-control rounded"  placeholder="example: 99 999 999" aria-label="telephone" aria-describedby="telephone-addon" required/>
                    @error('product_phone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="input-group rounded mb-3">
                    ...
                    <input type="email" name="product_email" class="form-control rounded"  placeholder="example: emailadress@gmail.com" aria-label="email" aria-describedby="email-addon" required />
                    @error('product_email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="container mb-5 text-center">
            <button class="btn btn-danger" type="submit"> Create offer</button>
        </div>
    {{ Form::close() }}
</div>
@endsection